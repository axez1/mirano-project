    ...
    <form id="order" class="order__form">
      ...
      <fieldset class="order__fieldset">
        ...
        <div class="order__input-group">
          ...
          <input type="text" class="order__input order__input_min" name="house" placeholder="Дом" />
          <input type="text" class="order__input order__input_min" name="apartment" placeholder="Квартира" />
        </div>
      </fieldset>
      ...
      <fieldset class="order__fieldset">
        <div class="order__payment">
          <label class="order__label-radio">
            <input class="order__radio" type="radio" name="payment-online" checked value={true} />Оплата онлайн
          </label>
        </div>
